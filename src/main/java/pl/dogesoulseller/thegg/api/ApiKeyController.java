...
public class ApiKeyController {
	...
	// TODO: Move somewhere else and improve exception
	...
	public ResponseEntity<GenericResponse> makeNewKey(@RequestParam(required = false) String name) {
		...
		// Generate key repeatedly in case a non-random UUID is generated (extremely low chance)
		String generatedKey;
		do {
